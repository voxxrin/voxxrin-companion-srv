...
import voxxrin.companion.domain.Subscriptions;
...
import voxxrin.companion.persistence.DaysDataService;
import voxxrin.companion.persistence.PresentationsDataService;
import voxxrin.companion.utils.Functions;
...
public class PresentationsResource {
    ...
    @GET("/presentations")
    @PermitAll
    @Produces("application/json;view=voxxrin.companion.serialization.Views$Presentations$List")
    ...
    @PermitAll
    @Produces("application/json;view=voxxrin.companion.serialization.Views$Presentations$Details")
    public Optional<Presentation> getPresentation(String id) {
        return presentationsDataService.findById(id);
    }

    @POST("/presentations")
    @Consumes("application/json;view=voxxrin.companion.serialization.Views$Presentations$Details")
